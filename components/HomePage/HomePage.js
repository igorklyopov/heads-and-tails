      ...
      <section className={styles.main}>
        ...
        <p className={styles.description}>
          <p>
            ...
            round of five throws is played. A "coin toss" is done by answering
            the question: Are you ready to rumble? - yes. Then it prompts the
            user to choose heads or tails. The game shows the user the result of
            each throw - guessed or not. After the end of each round, the game
            shows the player the result: the number of throws in the round, the
            number of sets when the player won and when the casino won, who won
            the round. The game then offers to play another round or end the
            game.
          </p>
          <p>
